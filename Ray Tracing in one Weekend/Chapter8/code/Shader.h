...
public:
    ...
    Shader(const char *vertexPath, const char *fragmentPath){
        ...
        try {
            ...
            cout << "Open shader files failed\n\t" << "Cannot find path: " << "[ " << vertexPath << " ] or [ " << fragmentPath << " ]\n";
        }
        ...
        if(!success){
            ...
            cout << "Compile fragment shader [ "<< vertexPath << " ] failed\n" << infoLog << endl;
        }
        ...
        if(!success){
            ...
            cout << "Compile fragment shader [ "<< fragmentPath << " ] failed\n" << infoLog << endl;
        }
    ...
    Shader(const char *vertexPath, const char *fragmentPath, const char *geometryPath){
        ...
        if(!success){
            glGetShaderInfoLog(vShader, 512, NULL, infoLog);
            cout << "Compile vertex shader [ "<< vertexPath << " ] failed\n" << infoLog << endl;
        }
        ...
        if(!success){
            ...
            cout << "Compile fragment shader [ "<< geometryPath << " ] failed\n" << infoLog << endl;
        }
